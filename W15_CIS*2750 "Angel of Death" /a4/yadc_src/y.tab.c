...
#line 11 "yadc_src/yadc.y" /* yacc.c:339  */
...
{
  "$end", "error", "$undefined", "TITLE", "FIELDS", "BUTTONS", "VALUE",
  "QUOTE", "EQUALS", "SEMICOLON", "OPENBR", "CLOSEBR", "COMMA", "$accept",
  "line", "currentline", "title", "tlist", "fields", "flist", "buttons",
  "blist", "value", YY_NULLPTR
};
#endif
...
{
       3,     2,     4,     5,     6,    11,     7,   -20,   -20,   -20,
     -20,     8,     9,    10,    14,   -20,     3,    12,    -7,    -6,
      16,   -20,    -4,    17,    19,   -20,    15,    21,   -20,    18,
      23,    22,   -20,   -20,   -20,    24,   -20,    25,   -20,   -20,
      26,    27,    28,    29,   -20,   -20
};
...
static const yytype_uint8 yydefact[] =
{
       4,     0,     0,     0,     0,     0,     3,     5,     6,     7,
       8,     0,     0,     0,     0,     1,     4,     0,     0,     0,
       0,     2,     0,     0,     0,    14,     0,     0,    18,     0,
       0,    12,     9,    11,    10,     0,    13,     0,    17,    21,
      16,    20,     0,     0,    15,    19
};
...
{
     -20,     1,   -20,   -20,    20,   -20,   -19,   -20,   -10,   -20
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     5,     6,     7,    33,     8,    26,     9,    29,    10
};
...
{
      24,    27,    31,    32,    25,    28,     1,     2,     3,     4,
      11,    15,    12,    13,    14,    17,    16,    21,    22,    18,
      19,    20,    30,    44,    34,    35,    36,    37,    31,    38,
      39,    40,    41,    45,     0,    24,    27,    23,    42,    43
};

static const yytype_int8 yycheck[] =
{
       7,     7,     6,     7,    11,    11,     3,     4,     5,     6,
       8,     0,     8,     8,     8,     7,     9,    16,     6,    10,
      10,     7,     6,    42,     7,     6,    11,     6,     6,    11,
       7,     7,     7,    43,    -1,     7,     7,    17,    12,    12
};
...
{
       0,     3,     4,     5,     6,    14,    15,    16,    18,    20,
      22,     8,     8,     8,     8,     0,     9,     7,    10,    10,
       7,    14,     6,    17,     7,    11,    19,     7,    11,    21,
       6,     6,     7,    17,     7,     6,    11,     6,    11,     7,
       7,     7,    12,    12,    19,    21
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 9:
#line 70 "yadc_src/yadc.y" /* yacc.c:1646  */
    { title = (yyvsp[-1]); }
#line 1273 "y.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 71 "yadc_src/yadc.y" /* yacc.c:1646  */
    { title = buildTitle(st); }
#line 1279 "y.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 75 "yadc_src/yadc.y" /* yacc.c:1646  */
    { stack_push(st,(yyvsp[-1])); titleCount++; }
#line 1285 "y.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 76 "yadc_src/yadc.y" /* yacc.c:1646  */
    { stack_push(st,(yyvsp[0])); titleCount++; }
#line 1291 "y.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 80 "yadc_src/yadc.y" /* yacc.c:1646  */
    { fieldNames = stackToArray(st, fieldCount); fieldValues = malloc(sizeof(char *) * fieldCount); }
#line 1297 "y.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 81 "yadc_src/yadc.y" /* yacc.c:1646  */
    { fieldNames = NULL; fieldValues = NULL; }
#line 1303 "y.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 85 "yadc_src/yadc.y" /* yacc.c:1646  */
    { stack_push(st, (yyvsp[-3])); fieldCount++; }
#line 1309 "y.tab.c" /* yacc.c:1646  */
    break;

  case 16:
#line 86 "yadc_src/yadc.y" /* yacc.c:1646  */
    { stack_push(st, (yyvsp[-1])); fieldCount++; }
#line 1315 "y.tab.c" /* yacc.c:1646  */
    break;

  case 17:
#line 90 "yadc_src/yadc.y" /* yacc.c:1646  */
    { buttonNames = stackToArray(st, fieldCount); buttonValues = malloc(sizeof(char *) * buttonCount); }
#line 1321 "y.tab.c" /* yacc.c:1646  */
    break;

  case 18:
#line 91 "yadc_src/yadc.y" /* yacc.c:1646  */
    { buttonNames = NULL; buttonValues = NULL; }
#line 1327 "y.tab.c" /* yacc.c:1646  */
    break;

  case 19:
#line 95 "yadc_src/yadc.y" /* yacc.c:1646  */
    { stack_push(st, (yyvsp[-3])); buttonCount++; }
#line 1333 "y.tab.c" /* yacc.c:1646  */
    break;

  case 20:
#line 96 "yadc_src/yadc.y" /* yacc.c:1646  */
    { stack_push(st, (yyvsp[-1])); buttonCount++; }
#line 1339 "y.tab.c" /* yacc.c:1646  */
    break;

  case 21:
#line 100 "yadc_src/yadc.y" /* yacc.c:1646  */
    { 
                                        i = getIndex(fieldNames, (yyvsp[-4]), fieldCount); 
                                        if(i == -1) {

                                            i = getIndex(buttonNames, (yyvsp[-4]), buttonCount);
                                            if(i == -1) {
                                                printf("PARSE ERROR: no match found for %s\n", (yyvsp[-4]));

                                            } else {
                                                buttonValues[i] = (yyvsp[-1]);
                                            }

                                        } else {
                                            fieldValues[i] = (yyvsp[-1]);
                                        }
                                    }
...
#line 118 "yadc_src/yadc.y" /* yacc.c:1906  */
