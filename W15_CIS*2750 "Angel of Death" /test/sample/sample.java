...
public class sample extends JFrame implements sampleFieldEdit {
	...
	public String getDCasshole() throws IllegalFieldValueException {
		if(floatCheck(asshole.getText())) {
			return asshole.getText();
		} else {
			throw new IllegalFieldValueException(asshole.getText());
		}
	}
	...
	public String getDCpotato() throws IllegalFieldValueException {
		if(integerCheck(potato.getText())) {
			return potato.getText();
		} else {
			throw new IllegalFieldValueException(potato.getText());
		}
	}
